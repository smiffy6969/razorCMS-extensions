...
<html xmlns:ng="http://angularjs.org" id="ng-app">
	<head>
		...
		<link type="text/css" rel="stylesheet" href="<?php echo RAZOR_BASE_URL ?>extension/theme/swamper/bootswatch-cerulean/style/style.css">
		...
		<!--[if IE 9]><link type="text/css" rel="stylesheet" href="<?php echo RAZOR_BASE_URL ?>extension/theme/swamper/bootswatch-cerulean/style/style_ie9.css"><![endif]-->
		<!--[if IE 8]><link type="text/css" rel="stylesheet" href="<?php echo RAZOR_BASE_URL ?>extension/theme/swamper/bootswatch-cerulean/style/style_ie8.css"><![endif]-->
	</head>
